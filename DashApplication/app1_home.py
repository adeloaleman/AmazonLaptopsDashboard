...
# spec1 = importlib.util.spec_from_file_location("module.name", "./components/navbar.py")
# navbar = importlib.util.module_from_spec(spec1)
# spec1.loader.exec_module(navbar)
# navbar.navbar
...
@app.callback(
    [
        Output(component_id='cloud2',           component_property='children'),
        Output(component_id='histo_div2',       component_property='children'),
        Output(component_id='brand_series_id2', component_property='value'),
        Output(component_id='ave_reviews2',     component_property='figure'),
        Output(component_id='ave_prices2',      component_property='figure'),
        Output(component_id='brand_id2',        component_property='options'),
        Output(component_id='brand_series_id2', component_property='options'),
    ],
    [
        Input(component_id='brand_id2', component_property='value'),
        Input(component_id='price_id2', component_property='value'),
    ],
    [
        State(component_id='brand_series_id2', component_property='value'),
    ]
)
...
@app.callback(
        Output(component_id='brand_div_id2',   component_property='children'),
    [
        Input(component_id='brand_series_id2', component_property='value')
    ],
)
