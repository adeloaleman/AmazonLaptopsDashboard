import scrapy
# scrapy crawl amazon_data -o amazon_data.json
...
class QuotesSpider(scrapy.Spider):
     ...
     def parse_compDetails(self, response):
          ...
          average_customer_reviews = product_details_values[5]
          
          number_reviews_div = response.css("#reviews-medley-footer")

          ## Esta parte ya no está funcionando
          ...
          # Ahora con esta líne puedo obtener la number_ratings_str 
          number_reviews_ratings_str = response.css("#acrCustomerReviewText::text").get()
          # Per aún no encentro la forma de recuperrar el number_ratings
